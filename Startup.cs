...
using WebApiCoreTest.IServices;
using WebApiCoreTest.Models;
using WebApiCoreTest.Services;
...
namespace WebApiCoreTest
{
	public class Startup
	{
		...
		public void ConfigureServices(IServiceCollection services)
		{
			...
			services.AddDbContext<elifedealContext>(options =>
			options.UseSqlServer(Environment.GetEnvironmentVariable("DbConnection")));
			//options.UseSqlServer(Configuration["KeyVaultName"]));
